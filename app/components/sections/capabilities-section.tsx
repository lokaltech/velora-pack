...
const stats = [
  ...
  },
  {
    value: "10,000 m²",
    label: "Factory Area",
    icon: "M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-6.75 4.5h6.75m-6.75 4.5h6.75m-6.75 4.5h6.75",
  },
  {
    value: "98%",
        ...
        <div className="flex flex-col gap-10 lg:grid lg:grid-cols-12 lg:items-start lg:gap-8">
          <div className="min-w-0 lg:col-span-4">
            ...
            <h2 className="mt-2 text-2xl font-bold leading-tight text-velora-navy sm:text-3xl lg:text-4xl">
              High Capacity.
              <br className="hidden sm:block" /> Consistent Quality.
            </h2>
            <p className="mt-4 text-sm leading-relaxed text-text/60 sm:text-base">
              We operate modern extrusion and converting lines with strict
              quality control—delivering consistent OPP film and bags for
              high-volume B2B clients across Indonesia and export markets.
            </p>
            <Link
              href="#about"
            ...
            {stats.map(({ value, label, icon }) => (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-sm font-bold text-velora-navy sm:text-base">
                    {value}
                  </p>
